export const metadata = {
  title: 'تماس با VORIX.SECURITY در الیگودرز',
  description: 'اطلاعات تماس و آدرس دفتر VORIX.SECURITY در لرستان، الیگودرز، میدان امام، پاساژ سینا، طبقه دوم.',
  alternates: { canonical: 'https://vorixsecurity.ir/contact' },
};

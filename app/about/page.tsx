export const metadata = {
  title: 'درباره نیما سرلک و VORIX.SECURITY',
  description: 'درباره نیما سرلک و VORIX.SECURITY؛ برند تخصصی خدمات امنیت سایبری، امنیت دیجیتال و راهکارهای فناوری در الیگودرز و لرستان.',
  alternates: { canonical: 'https://vorixsecurity.ir/about' },
};

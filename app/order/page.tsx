export const metadata = {
  title: 'ثبت درخواست خدمات امنیت سایبری و فناوری',
  description: 'ثبت درخواست مشاوره و سفارش خدمات VORIX.SECURITY در حوزه امنیت سایبری، امنیت دیجیتال، بازیابی اطلاعات و فناوری.',
  alternates: { canonical: 'https://vorixsecurity.ir/order' },
};

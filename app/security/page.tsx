export const metadata = {
  title: 'خدمات امنیت سایبری و فناوری',
  description: 'معرفی خدمات VORIX.SECURITY شامل امنیت سایبری، بازیابی اطلاعات، امنیت حساب‌های آنلاین، دوربین مداربسته، هوش مصنوعی، OSINT و راهکارهای فناوری.',
  alternates: { canonical: 'https://vorixsecurity.ir/security' },
};
